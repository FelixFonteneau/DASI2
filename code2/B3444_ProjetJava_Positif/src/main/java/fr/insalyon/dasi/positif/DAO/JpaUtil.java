...
public class JpaUtil {
     ...
     */
    public static final String PERSISTENCE_UNIT_NAME = "PositIFPU";
    /**
     ...
     * À utiliser uniquement au début de la méthode main() [projet
     * Java Application] ou dans la méthode init() de la Servlet Contrôleur
     * (ActionServlet) [projet Web Application].
     */
     ...
     * À utiliser uniquement à la fin de la méthode main() [projet
     ...
     * À utiliser uniquement au niveau Service.
     */
