...
*/
    public static void main(String args[]) {
        ...
        String description = "Quel test voulez vous effectuer ? (Tapez le code entre parenthèse)\n"
                ...
                + "Login Employe (le)\n"
                + "Recupérer un medium avec son ID\n"
    ...
    public static Medium recupererMedium(){
        Services s = new Services();
        int id = Saisie.lireInteger("Saisissez l'id du medium : ");
        Long idL = new Long(id);
        Medium m = s.recupererMedium(idL);
    ...
    public static void testConsultation() {
        ...
        if (co1 != null) {
            ...
            s.commencerConsultation(co1);
            //GetConsultEnCours
            System.out.println("Date debut de la consultation : " + s.getConsultEnCours(co1.getEmploye()).getDateConsultation());
            //TestGenerationPredictions
            Integer amour = Saisie.lireInteger("Saisissez le score d'amour (1 à 4) : ");
            Integer travail = Saisie.lireInteger("Saisissez le score de santé (1 à 4) : ");
            Integer sante = Saisie.lireInteger("Saisissez le score de travail (1 à 4) : ");
            List<String> predictions = s.genererPredictions(co1, amour, travail, sante);
            System.out.println("Amour : " + predictions.get(0) + "\nSante : " + predictions.get(1) + "\nTravail : " + predictions.get(2));
            //TestFinirConsultation
            s.finirConsultation(co1, "Le client est charmé !");
        } else {
